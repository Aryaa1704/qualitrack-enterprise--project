...
7. Open the application:
   ...
   - Home: <https://qualitrack-enterprise-project.onrender.com/>
   
   - Health check: <https://qualitrack-enterprise-project.onrender.com/health>
...
3. Add environment variables:
   ...
   ```text
   DATABASE_URL=:///./qualitrack.db
   SECRET_KEY=<strong-randomset>
   DEBUG=false
   ```
